...
switch value
    ...
    case 13
        disp("----------------------------")
        disp("moveRobot(robot,0,"+Servo0+")")
        disp("moveRobot(robot,1,"+Servo1+")")
        disp("moveRobot(robot,2,"+Servo2+")")
        disp("moveRobot(robot,3,"+Servo3+")")
        disp("moveRobot(robot,4,"+Servo4+")")
        disp("moveRobot(robot,5,"+Servo5+")")
    case 47
        disp('Exiting')
        run=0;
end
